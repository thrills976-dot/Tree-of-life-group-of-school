...
const images = [
  ...
  "https://images.unsplash.com/photo-1593113580332-828c22626459?auto=format&fit=crop&q=80&w=800",
    ...
    <div className="bg-warm-cream min-h-screen pt-32 pb-24">
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          >
            A glimpse into everyday life, special events, and the beautiful environment at Tree of Life.
          </motion.p>
        </div>
