...
import { MapPin, Phone, MessageCircle, Globe, BookOpen } from "lucide-react";
    ...
    <div id="contact" className="bg-warm-cream py-24">
      <div className="container mx-auto px-6 md:px-12 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          >
            We would love to hear from you. Our team is ready to answer all your questions.
          </motion.p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-earth-brown/80 text-sm mt-1">2802 Amalinda Drive, Harare, Zimbabwe, 0000</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-nature-green-dark">Location</h4>
                    <p className="text-earth-brown/80 text-sm mt-1">Harare, Zimbabwe</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-nature-green-dark">Services & Specialties</h4>
                    <p className="text-earth-brown/80 text-sm mt-1">In-person classes</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-nature-green-dark">Contact Info</h4>
                    <p className="text-earth-brown/80 text-sm mt-1">Call and WhatsApp: 077 847 6519</p>
                  </div>
                </div>
              </div>
